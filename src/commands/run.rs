...
impl RunCommon {
    ...
    pub(crate) fn ensure_allow_precompiled(&self) -> Result<()> {
    ...
    pub(crate) fn load_module(&self, engine: &Engine, path: &Path) -> Result<RunTarget> {
    ...
    pub(crate) fn load_module_contents(
        &self,
        engine: &Engine,
        path: &Path,
        bytes: &[u8],
